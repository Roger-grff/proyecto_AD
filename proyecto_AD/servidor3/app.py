...
def login():
    ...
    return render_template("login.html", nodo="Servidor 3")
...
def tareas():
    ...
    return render_template("tareas.html", tareas=lista,
                           ahora=datetime.now(), nodo="Servidor 3")
...
def entregar(tarea_id):
    ...
    return render_template("entregar.html", tarea=tarea,
                           entrega=entrega, ahora=ahora, nodo="Servidor 3")
...
def mis_entregas():
    ...
    return render_template("mis_entregas.html", entregas=entregas, nodo="Servidor 3")
